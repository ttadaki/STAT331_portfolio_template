...
military <- read_xlsx(here::here("Week 4", "Practice Activity 3", "gov_spending_per_capita.xlsx"), 
                      sheet = 9, 
                      skip = 7, 
                      n_max = 190)
```
...
```{r, eval = FALSE}
cont_region <- read_xlsx(here::here("Week 4", "Practice Activity 3", "gov_spending_per_capita.xlsx"), 
